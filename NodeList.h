...
public:
    ...
    //Used for checking if a particular NodeList contains a specific node
    bool containsNode(int row, int col);
    
    /*
    Returns the index position of input node, returns -1 if the node is not
    found
    */
...
private:
    ...
    //MILESTONE 4 CHANGE (line 50 commented out):
    Node** nodes;
